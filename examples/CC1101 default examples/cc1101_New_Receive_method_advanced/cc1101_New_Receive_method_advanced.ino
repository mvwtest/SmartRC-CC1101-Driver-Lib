...
void setup(){
   ...
   ELECHOUSE_cc1101.setGDO(28,0);        // 設置 (gdo0,gdo2)Pin. 本例0表示忽略 Gdo2 .
    ...
    ELECHOUSE_cc1101.setDeviation(47.60);   // 设置频率偏差（kHz）the Frequency deviation. 範圍： 1.58 to 380.85. 默認 47.60 kHz.
    ELECHOUSE_cc1101.setChannel(0);         // 设置频道 範圍： 0 to 255. 默認： 0.
    ELECHOUSE_cc1101.setChsp(199.95);       // The channel spacing is multiplied by the channel number CHAN and added to the base frequency in kHz. Value from 25.39 to 405.45. Default is 199.95 kHz.
    ELECHOUSE_cc1101.setRxBW(812.50);       // 接收带宽Receive Bandwidth-kHz. 範圍： 58.03 to 812.50. 默認： 812.50 kHz.
    ELECHOUSE_cc1101.setDRate(99.97);       // 数据速率 （Data Rate kBaud） 範圍： 0.02 to 1621.83. 默認： 99.97 kBaud!
    ELECHOUSE_cc1101.setPA(10);             // 发射功率. 根据频段，可以进行以下设置.  (-30  -20  -15  -10  -6    0    5    7    10   11   12) 默認 max!
    ...
    ELECHOUSE_cc1101.setManchester(0);      // 启用曼彻斯特编解码（Manchester encoding/decoding）. 0 = Disable. 1 = Enable.
